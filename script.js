...
function reloadgame(){
    document.getElementById('imaginID').value="";
    document.querySelector('.score').textContent=100
    document.querySelector('#screen').textContent="Start guessing..."
...
function generateRandomInteger(max) {
  ...
  function maincheck(){
    ...
    if(initialscore!==0){
       ...
       document.querySelector('.message').textContent="Your score Is High"
           initialscore--
         document.querySelector('.score').textContent=initialscore
       }
       else if(inputnumber<randomnumber){
        document.querySelector('.message').textContent="Your score Is Low"
        initialscore--
        document.querySelector('.score').textContent=initialscore
       }
       else{
        ...
        document.querySelector('.message').textContent="Game Over :slightly_smiling_face: :slightly_smiling_face: your score is 0"
    }
   }
